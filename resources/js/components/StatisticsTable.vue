    ...
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
      <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-900 dark:text-gray-400">
        <tr>
          ...
          <th scope="col" class="px-6 py-3">start_of_service</th>
          <th scope="col" class="px-6 py-3">end_of_service</th>
          <th scope="col" class="px-6 py-3">person_start_service</th>
      ...
      <tbody>
        ...
        >
          ...
          <td class="px-6 py-4">{{ value.start_of_service }}</td>
          <td class="px-6 py-4">{{ value.end_of_service }}</td>
          <td class="px-6 py-4">{{ value.person_start_service }}</td>
          <td class="px-6 py-4">{{ value.school }}</td>
