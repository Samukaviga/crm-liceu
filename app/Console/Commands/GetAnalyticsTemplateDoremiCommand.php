...
use App\Services\AnalyticsDoremi;
...
class GetAnalyticsTemplateDoremiCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'analytics-template-doremi';
     ...
     * @var string
     */
    protected $description = 'Obter dados analíticos dos templates do Doremi';
    ...
    public function handle()
    {
        ...
        $analyticsService = new AnalyticsDoremi();

        $templates = Template::where('school_id', 5)->get();
