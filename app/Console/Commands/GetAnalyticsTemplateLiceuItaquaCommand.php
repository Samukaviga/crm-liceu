...
class GetAnalyticsTemplateLiceuItaquaCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'analytics-template-liceu-itaqua';
     ...
     * @var string
     */
    protected $description = 'Obter dados analíticos dos templates do Liceu Itaqua';
    ...
    public function handle()
    {
        ...
        $templates = Template::where('school_id', 2)->get();
