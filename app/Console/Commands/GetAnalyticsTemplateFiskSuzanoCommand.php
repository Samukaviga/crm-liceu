...
class GetAnalyticsTemplateFiskSuzanoCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'analytics-template-fisk-suzano';
     ...
     * @var string
     */
    protected $description = 'Obter dados analíticos dos templates do Fisk Suzano';
    ...
    public function handle()
    {
        ...
        $templates = Template::where('school_id', 8)->get();
