...
use App\Services\AnalyticsLiceuSuzano;
...
class GetAnalyticsTemplateLiceuSuzanoCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'analytics-template-liceu-suzano';
     ...
     * @var string
     */
    protected $description = 'Obeter dados analíticos dos templates do Liceu Suzano';
    ...
    public function handle()
    {
        ...
        $analyticsService = new AnalyticsLiceuSuzano();

        $templates = Template::where('school_id', 3)->get();
