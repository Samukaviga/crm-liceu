...
use App\Services\AnalyticsFiskItaqua;
...
class GetAnalyticsTemplateFiskItaquaCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'analytics-template-fisk-itaqua';
     ...
     * @var string
     */
    protected $description = 'Obter dados analíticos dos templates do Fisk Itaqua';
    ...
    public function handle()
    {
        ...
        $analyticsService = new AnalyticsFiskItaqua();

        $templates = Template::where('school_id', 7)->get();
